                ...
                <div class="card-body mt-4">
                  <div class="col-lg-12 mb-lg-5">
                      ...
                      <div class=" float-right d-flex align-content-center">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                      <select class="form-control" id="id_user_donneur" name="id_user_donneur">
                                        <option value="" hidden>Donneur</option>
                        ...
                        <a class="btn btn-primary float-right mb-3" href="{{route('alimentations_caisse.create')}}"> Nouveau alimentation</a>
                      </div>
                  </div>
                      ...
                      <tbody>
                        @foreach ($alimentations as $index=>$alimentation)
                            <tr>
                                ...
                                <td>{{$alimentation->donneur->name}}</td>
                                <td>{{$alimentation->montant}}</td>
                                <td>{{$alimentation->confirmation}}</td>
                                <td>
